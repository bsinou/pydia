...
import org.sinou.pydia.openapi.model.TokenServiceResetPasswordTokenBody
...
class TokenServiceApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun resetPasswordToken(userLogin: kotlin.String, body: TokenServiceResetPasswordTokenBody) : RestResetPasswordTokenResponse {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun resetPasswordTokenWithHttpInfo(userLogin: kotlin.String, body: TokenServiceResetPasswordTokenBody) : ApiResponse<RestResetPasswordTokenResponse?> {
     ...
     * @return RequestConfig
     */
    fun resetPasswordTokenRequestConfig(userLogin: kotlin.String, body: TokenServiceResetPasswordTokenBody) : RequestConfig<TokenServiceResetPasswordTokenBody> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
