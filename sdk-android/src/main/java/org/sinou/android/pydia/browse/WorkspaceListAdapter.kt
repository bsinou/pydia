...
class WorkspaceListAdapter(private val onItemClicked: (accountID: String, action: String) -> Unit) :
    ListAdapter<RLiveSession, WorkspaceListAdapter.ViewHolder>(LiveSessionDiffCallback()) {
