package org.sinou.pydia.client.core.ui.login.nav
...
class CellsRouteNavigator : RouteNavigator {

    /**
     * Using a single state here, not a list of states. As a result, if you quickly
