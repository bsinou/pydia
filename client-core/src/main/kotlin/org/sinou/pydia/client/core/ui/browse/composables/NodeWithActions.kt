...
import org.sinou.pydia.client.core.ui.core.encodeStateSetForRoute
import org.sinou.pydia.client.core.ui.core.lazyStateID
import org.sinou.pydia.client.core.ui.core.lazyStateIDs
    ...
    val launchMono: (NodeAction, StateID) -> Unit = { action, passedStateID ->
        ...
        when (action) {
            is NodeAction.CopyTo -> {
                currentAction.value = AppNames.ACTION_COPY
                val initialRoute =
                    "${NodeAction.SelectTargetFolder.id}/${encodeStateForRoute(passedStateID.parentFolder())}"
                navController.navigate(initialRoute)
            }
