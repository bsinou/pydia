...
import org.sinou.pydia.openapi.model.RoleServiceSetRoleBody
...
class RoleServiceApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun setRoleWithHttpInfo(uuid: kotlin.String, body: RoleServiceSetRoleBody) : ApiResponse<IdmRole?> {
        val localVariableConfig = setRoleRequestConfig(uuid = uuid, body = body)

        return request<RoleServiceSetRoleBody, IdmRole>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun setRoleRequestConfig(uuid: kotlin.String, body: RoleServiceSetRoleBody) : RequestConfig<RoleServiceSetRoleBody> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
