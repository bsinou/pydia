...
import org.sinou.pydia.openapi.model.UserServicePutRolesBody
import org.sinou.pydia.openapi.model.UserServicePutUserBody
...
class UserServiceApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun deleteUser(login: kotlin.String, uuid: kotlin.String? = null, groupPath: kotlin.String? = null, attributes: kotlin.String? = null, password: kotlin.String? = null, oldPassword: kotlin.String? = null, isGroup: kotlin.Boolean? = null, groupLabel: kotlin.String? = null, lastConnected: kotlin.Int? = null, policiesContextEditable: kotlin.Boolean? = null) : RestDeleteResponse {
        val localVarResponse = deleteUserWithHttpInfo(login = login, uuid = uuid, groupPath = groupPath, attributes = attributes, password = password, oldPassword = oldPassword, isGroup = isGroup, groupLabel = groupLabel, lastConnected = lastConnected, policiesContextEditable = policiesContextEditable)
    ...
    fun deleteUserWithHttpInfo(login: kotlin.String, uuid: kotlin.String?, groupPath: kotlin.String?, attributes: kotlin.String?, password: kotlin.String?, oldPassword: kotlin.String?, isGroup: kotlin.Boolean?, groupLabel: kotlin.String?, lastConnected: kotlin.Int?, policiesContextEditable: kotlin.Boolean?) : ApiResponse<RestDeleteResponse?> {
        val localVariableConfig = deleteUserRequestConfig(login = login, uuid = uuid, groupPath = groupPath, attributes = attributes, password = password, oldPassword = oldPassword, isGroup = isGroup, groupLabel = groupLabel, lastConnected = lastConnected, policiesContextEditable = policiesContextEditable)
     ...
     */
    fun deleteUserRequestConfig(login: kotlin.String, uuid: kotlin.String?, groupPath: kotlin.String?, attributes: kotlin.String?, password: kotlin.String?, oldPassword: kotlin.String?, isGroup: kotlin.Boolean?, groupLabel: kotlin.String?, lastConnected: kotlin.Int?, policiesContextEditable: kotlin.Boolean?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getUser(login: kotlin.String, uuid: kotlin.String? = null, groupPath: kotlin.String? = null, attributes: kotlin.String? = null, password: kotlin.String? = null, oldPassword: kotlin.String? = null, isGroup: kotlin.Boolean? = null, groupLabel: kotlin.String? = null, lastConnected: kotlin.Int? = null, policiesContextEditable: kotlin.Boolean? = null) : IdmUser {
        val localVarResponse = getUserWithHttpInfo(login = login, uuid = uuid, groupPath = groupPath, attributes = attributes, password = password, oldPassword = oldPassword, isGroup = isGroup, groupLabel = groupLabel, lastConnected = lastConnected, policiesContextEditable = policiesContextEditable)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getUserWithHttpInfo(login: kotlin.String, uuid: kotlin.String?, groupPath: kotlin.String?, attributes: kotlin.String?, password: kotlin.String?, oldPassword: kotlin.String?, isGroup: kotlin.Boolean?, groupLabel: kotlin.String?, lastConnected: kotlin.Int?, policiesContextEditable: kotlin.Boolean?) : ApiResponse<IdmUser?> {
        val localVariableConfig = getUserRequestConfig(login = login, uuid = uuid, groupPath = groupPath, attributes = attributes, password = password, oldPassword = oldPassword, isGroup = isGroup, groupLabel = groupLabel, lastConnected = lastConnected, policiesContextEditable = policiesContextEditable)
     ...
     * @return RequestConfig
     */
    fun getUserRequestConfig(login: kotlin.String, uuid: kotlin.String?, groupPath: kotlin.String?, attributes: kotlin.String?, password: kotlin.String?, oldPassword: kotlin.String?, isGroup: kotlin.Boolean?, groupLabel: kotlin.String?, lastConnected: kotlin.Int?, policiesContextEditable: kotlin.Boolean?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (uuid != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun putRolesWithHttpInfo(login: kotlin.String, body: UserServicePutRolesBody) : ApiResponse<IdmUser?> {
        val localVariableConfig = putRolesRequestConfig(login = login, body = body)

        return request<UserServicePutRolesBody, IdmUser>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun putRolesRequestConfig(login: kotlin.String, body: UserServicePutRolesBody) : RequestConfig<UserServicePutRolesBody> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun putUserWithHttpInfo(login: kotlin.String, body: UserServicePutUserBody) : ApiResponse<IdmUser?> {
        val localVariableConfig = putUserRequestConfig(login = login, body = body)

        return request<UserServicePutUserBody, IdmUser>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun putUserRequestConfig(login: kotlin.String, body: UserServicePutUserBody) : RequestConfig<UserServicePutUserBody> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
