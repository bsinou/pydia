...
import org.sinou.pydia.openapi.model.ConfigServicePutConfigBody
import org.sinou.pydia.openapi.model.ConfigServicePutDataSourceBody
...
class ConfigServiceApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteDataSourceWithHttpInfo(name: kotlin.String, disabled: kotlin.Boolean?, storageType: StorageTypeDeleteDataSource?, storageConfiguration: kotlin.String?, objectsServiceName: kotlin.String?, objectsHost: kotlin.String?, objectsPort: kotlin.Int?, objectsSecure: kotlin.Boolean?, objectsBucket: kotlin.String?, objectsBaseFolder: kotlin.String?, apiKey: kotlin.String?, apiSecret: kotlin.String?, peerAddress: kotlin.String?, watch: kotlin.Boolean?, flatStorage: kotlin.Boolean?, skipSyncOnRestart: kotlin.Boolean?, encryptionMode: EncryptionModeDeleteDataSource?, encryptionKey: kotlin.String?, versioningPolicyName: kotlin.String?, creationDate: kotlin.Int?, lastSynchronizationDate: kotlin.Int?) : ApiResponse<RestDeleteDataSourceResponse?> {
        val localVariableConfig = deleteDataSourceRequestConfig(name = name, disabled = disabled, storageType = storageType, storageConfiguration = storageConfiguration, objectsServiceName = objectsServiceName, objectsHost = objectsHost, objectsPort = objectsPort, objectsSecure = objectsSecure, objectsBucket = objectsBucket, objectsBaseFolder = objectsBaseFolder, apiKey = apiKey, apiSecret = apiSecret, peerAddress = peerAddress, watch = watch, flatStorage = flatStorage, skipSyncOnRestart = skipSyncOnRestart, encryptionMode = encryptionMode, encryptionKey = encryptionKey, versioningPolicyName = versioningPolicyName, creationDate = creationDate, lastSynchronizationDate = lastSynchronizationDate)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getDataSource(name: kotlin.String, disabled: kotlin.Boolean? = null, storageType: StorageTypeGetDataSource? = StorageTypeGetDataSource.LOCAL, storageConfiguration: kotlin.String? = null, objectsServiceName: kotlin.String? = null, objectsHost: kotlin.String? = null, objectsPort: kotlin.Int? = null, objectsSecure: kotlin.Boolean? = null, objectsBucket: kotlin.String? = null, objectsBaseFolder: kotlin.String? = null, apiKey: kotlin.String? = null, apiSecret: kotlin.String? = null, peerAddress: kotlin.String? = null, watch: kotlin.Boolean? = null, flatStorage: kotlin.Boolean? = null, skipSyncOnRestart: kotlin.Boolean? = null, encryptionMode: EncryptionModeGetDataSource? = EncryptionModeGetDataSource.CLEAR, encryptionKey: kotlin.String? = null, versioningPolicyName: kotlin.String? = null, creationDate: kotlin.Int? = null, lastSynchronizationDate: kotlin.Int? = null) : ObjectDataSource {
        val localVarResponse = getDataSourceWithHttpInfo(name = name, disabled = disabled, storageType = storageType, storageConfiguration = storageConfiguration, objectsServiceName = objectsServiceName, objectsHost = objectsHost, objectsPort = objectsPort, objectsSecure = objectsSecure, objectsBucket = objectsBucket, objectsBaseFolder = objectsBaseFolder, apiKey = apiKey, apiSecret = apiSecret, peerAddress = peerAddress, watch = watch, flatStorage = flatStorage, skipSyncOnRestart = skipSyncOnRestart, encryptionMode = encryptionMode, encryptionKey = encryptionKey, versioningPolicyName = versioningPolicyName, creationDate = creationDate, lastSynchronizationDate = lastSynchronizationDate)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getDataSourceWithHttpInfo(name: kotlin.String, disabled: kotlin.Boolean?, storageType: StorageTypeGetDataSource?, storageConfiguration: kotlin.String?, objectsServiceName: kotlin.String?, objectsHost: kotlin.String?, objectsPort: kotlin.Int?, objectsSecure: kotlin.Boolean?, objectsBucket: kotlin.String?, objectsBaseFolder: kotlin.String?, apiKey: kotlin.String?, apiSecret: kotlin.String?, peerAddress: kotlin.String?, watch: kotlin.Boolean?, flatStorage: kotlin.Boolean?, skipSyncOnRestart: kotlin.Boolean?, encryptionMode: EncryptionModeGetDataSource?, encryptionKey: kotlin.String?, versioningPolicyName: kotlin.String?, creationDate: kotlin.Int?, lastSynchronizationDate: kotlin.Int?) : ApiResponse<ObjectDataSource?> {
        val localVariableConfig = getDataSourceRequestConfig(name = name, disabled = disabled, storageType = storageType, storageConfiguration = storageConfiguration, objectsServiceName = objectsServiceName, objectsHost = objectsHost, objectsPort = objectsPort, objectsSecure = objectsSecure, objectsBucket = objectsBucket, objectsBaseFolder = objectsBaseFolder, apiKey = apiKey, apiSecret = apiSecret, peerAddress = peerAddress, watch = watch, flatStorage = flatStorage, skipSyncOnRestart = skipSyncOnRestart, encryptionMode = encryptionMode, encryptionKey = encryptionKey, versioningPolicyName = versioningPolicyName, creationDate = creationDate, lastSynchronizationDate = lastSynchronizationDate)
     ...
     * @return RequestConfig
     */
    fun getDataSourceRequestConfig(name: kotlin.String, disabled: kotlin.Boolean?, storageType: StorageTypeGetDataSource?, storageConfiguration: kotlin.String?, objectsServiceName: kotlin.String?, objectsHost: kotlin.String?, objectsPort: kotlin.Int?, objectsSecure: kotlin.Boolean?, objectsBucket: kotlin.String?, objectsBaseFolder: kotlin.String?, apiKey: kotlin.String?, apiSecret: kotlin.String?, peerAddress: kotlin.String?, watch: kotlin.Boolean?, flatStorage: kotlin.Boolean?, skipSyncOnRestart: kotlin.Boolean?, encryptionMode: EncryptionModeGetDataSource?, encryptionKey: kotlin.String?, versioningPolicyName: kotlin.String?, creationDate: kotlin.Int?, lastSynchronizationDate: kotlin.Int?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (disabled != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun putConfigWithHttpInfo(fullPath: kotlin.String, body: ConfigServicePutConfigBody) : ApiResponse<RestConfiguration?> {
        val localVariableConfig = putConfigRequestConfig(fullPath = fullPath, body = body)

        return request<ConfigServicePutConfigBody, RestConfiguration>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun putConfigRequestConfig(fullPath: kotlin.String, body: ConfigServicePutConfigBody) : RequestConfig<ConfigServicePutConfigBody> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun putDataSourceWithHttpInfo(name: kotlin.String, body: ConfigServicePutDataSourceBody) : ApiResponse<ObjectDataSource?> {
        val localVariableConfig = putDataSourceRequestConfig(name = name, body = body)

        return request<ConfigServicePutDataSourceBody, ObjectDataSource>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun putDataSourceRequestConfig(name: kotlin.String, body: ConfigServicePutDataSourceBody) : RequestConfig<ConfigServicePutDataSourceBody> {
        val localVariableBody = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
